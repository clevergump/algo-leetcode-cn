...
public class _13_My2 {
    ...
    public static int romanToInt(String roman) {
        ...
        for (int i = 0; i < length; i++) {
            String curBitStr = roman.substring(i, i + 1);
            ret += getBitValue(curBitStr);
        }
        return ret;
    }

    private static int getBitValue(String bitStr) {
        switch (bitStr) {
            case "a":
                return 4;
            case "b":
        ...
        throw new IllegalArgumentException("bitStr is unsupported roman string.");
    }
}
